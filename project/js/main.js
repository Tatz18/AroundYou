...
function showPlace(a, b) {
    if (b == google.maps.places.PlacesServiceStatus.OK) {
        ...
        destMarker = new google.maps.Marker({
            ...
            placeName = a.name,
            routemap(userLoc, a.geometry.location),
            directionsDisplay.setMap(null),
            directionsDisplay.suppressMarkers = !0,
            directionsDisplay.setMap(map),
            placeSite = a.website ? a.website : a.url,
            placeAddress = a.formatted_address,
            $(".uDestination")
            .html("You can try <br/><img src='" + a.icon + '/><a href='" + placeSite + "' target='_blank'>" + placeName + '</a><a href ="' + a.url + '" class="rating star' + Math.ceil(a.rating) + '"><span class="">based on ' + a.rating + ' rating</span></a><br/>Call Them at <a href="tel:' + a.international_phone_number + '"> ' + a.international_phone_number + " </a>"), $(".mapAddress").html(placeAddress), $(".btmRow,.recommendation,.mapAddress,.uDestination")
               .fadeIn(function() {
                fnWaiting.fadeOut()
            })
    }
