...
function showPlace(a, b) {
   if (b == google.maps.places.PlacesServiceStatus.OK) {
      ...
      destMarker = new google.maps.Marker({
       ...
       $(".uDestination").html("You can try <br/><img src='" + a.icon + '><a href ="' + a.url + '" class="rating star' + Math.ceil(a.rating) + '"><span class="">based on ' + a.rating + ' rating</span></a><br/>Call Them at <a href="tel:' + a.international_phone_number + '"> ' + a.international_phone_number + " </a>"),
